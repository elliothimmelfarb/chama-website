...
export const MIGRATIONS = [
  ...
  },
  {
    ...
    statements: [
      ...
      // owner at once, used to be able to write a second one.
      `create unique index if not exists transcripts_booking_idx on transcripts(booking_id) where booking_id is not null`
    ]
  }
];
