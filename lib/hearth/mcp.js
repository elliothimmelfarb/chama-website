...
import { readAccessToken, readApiKey, SCOPE_KEYS } from "./oauth.js";
...
export async function resolveBearer(header) {
  ...
  return { ...actor, scopes: new Set(Array.isArray(grant.scopes) ? grant.scopes : SCOPE_KEYS), actorKind, actorRef, clientName: grant.clientName || grant.name || "" };
}
